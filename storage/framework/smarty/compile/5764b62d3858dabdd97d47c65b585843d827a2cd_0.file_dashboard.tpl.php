<?php
/* Smarty version 5.5.1, created on 2025-06-25 23:19:20
  from 'file:admin/dashboard.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.5.1',
  'unifunc' => 'content_685c75e8c96316_04432343',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '5764b62d3858dabdd97d47c65b585843d827a2cd' => 
    array (
...
function content_685c75e8c96316_04432343 (\Smarty\Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->getInheritance()->instanceBlock($_smarty_tpl, 'Block_1366767290685c75e8c6b264_35041690', "title");
?>


<?php 
$_smarty_tpl->getInheritance()->instanceBlock($_smarty_tpl, 'Block_2035286147685c75e8c6da51_57157974', "content");
$_smarty_tpl->getInheritance()->endChild($_smarty_tpl, "layouts/app.tpl", $_smarty_current_dir);
}
/* {block "title"} */
class Block_1366767290685c75e8c6b264_35041690 extends \Smarty\Runtime\Block
{
public function callBlock(\Smarty\Template $_smarty_tpl) {
$_smarty_current_dir = '/Users/user/dev/projects/Buyandbye/resources/views/smarty/admin';
?>
Admin Dashboard - Buyandbye<?php
}
}
/* {/block "title"} */
/* {block "content"} */
class Block_2035286147685c75e8c6da51_57157974 extends \Smarty\Runtime\Block
{
public function callBlock(\Smarty\Template $_smarty_tpl) {
$_smarty_current_dir = '/Users/user/dev/projects/Buyandbye/resources/views/smarty/admin';
?>
                            ...
                            <button class="ml-2 md:ml-auto">
                                <svg class="w-4 h-4 md:w-5 md:h-5 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                                        ...
                                        <?php $_smarty_tpl->renderSubTemplate("file:partials/admin-sidebar.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('active_page'=>"overview"), (int) 0, $_smarty_current_dir);
?>
                </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-3 md:ml-4">
                                ...
                                <p class="text-lg md:text-2xl font-bold text-black"><?php echo $_smarty_tpl->getValue('stats')['new_orders'];?>
</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-3 md:ml-4">
                                ...
                                <p class="text-lg md:text-2xl font-bold text-black"><?php echo $_smarty_tpl->getValue('stats')['orders_processing'];?>
</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-3 md:ml-4">
                                ...
                                <p class="text-lg md:text-2xl font-bold text-black"><?php echo $_smarty_tpl->getValue('stats')['orders_completed'];?>
</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-3 md:ml-4">
                                ...
                                <p class="text-lg md:text-2xl font-bold text-black"><?php echo $_smarty_tpl->getValue('stats')['users_count'];?>
</p>
                            </div>
                        </div>
                    </div>
