                ...
                <div class="lg:col-span-8">
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        ...
                        <div class="flex items-center justify-between mb-6">
                            <h1 class="text-2xl font-medium text-gray-900">Cart (<?php echo $_smarty_tpl->getValue('cart_count');?>
 products)</h1>
                            <button class="text-red-500 hover:text-red-600 text-sm font-medium flex items-center clear-cart-btn">
...
?>
                                    <div class="py-6 cart-item" data-product-id="<?php echo $_smarty_tpl->getValue('product_id');?>
">
...
" class="w-15 h-15 object-cover rounded-lg">
                                                ...
                                                <div>
                                                    <h3 class="font-medium text-gray-900"><?php echo (($tmp = $_smarty_tpl->getValue('item')['name'] ?? null)===null||$tmp==='' ? 'Product' ?? null : $tmp);?>
</h3>
                                                    <?php if ((true && (true && null !== ($_smarty_tpl->getValue('item')['size'] ?? null))) && $_smarty_tpl->getValue('item')['size']) {?>
                                                        <p class="text-sm text-gray-500"><?php echo $_smarty_tpl->getValue('item')['size'];?>
</p>
                                                    <?php }?>
                                                </div>
                                            </div>
                                            ...
                                            <div class="md:col-span-2 flex items-center justify-center">
                                                <div class="flex items-center border border-gray-300 rounded-lg">
                                                    <button class="p-2 hover:bg-gray-50 text-gray-400 decrease-quantity" data-product-id="<?php echo $_smarty_tpl->getValue('product_id');?>
">
                                                    ...
                                                    <span class="px-4 py-2 text-sm font-medium item-quantity"><?php echo (($tmp = $_smarty_tpl->getValue('item')['quantity'] ?? null)===null||$tmp==='' ? 1 ?? null : $tmp);?>
</span>
                                                    <button class="p-2 hover:bg-gray-50 text-gray-400 increase-quantity" data-product-id="<?php echo $_smarty_tpl->getValue('product_id');?>
">
                                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                                d="M12 4v16m8-8H4" />
...
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
                            <?php } else { ?>
                                ...
                                <div class="py-12 text-center">
                                    ...
                                    <a href="/" class="inline-flex items-center px-4 py-2 bg-gray-900 text-white rounded-lg hover:bg-gray-800">
                                        Continue Shopping
                                    </a>
                                </div>
                            <?php }?>
                        ...
                        <div class="mt-8 bg-gray-900 rounded-lg p-6 text-white">
                            <div class="flex items-center justify-between">
                                <div>
                                    <h3 class="text-lg font-medium mb-1">Check the newest care products</h3>
                                    <p class="text-gray-300 text-sm">Official cosmetic reseller</p>
                                </div>
                ...
                <div class="lg:col-span-4 mt-8 lg:mt-0">
                    <div class="bg-white rounded-lg shadow-sm">
                        ...
                        <div class="p-6">
                            ...
                            <button
                                class="w-full mt-6 bg-black text-white py-3 rounded-lg font-medium hover:bg-gray-800 transition-colors checkout-btn"
