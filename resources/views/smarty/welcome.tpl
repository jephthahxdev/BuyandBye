                        ...
                        <div class="product-card bg-white overflow-hidden relative group">
                            ...
                            <div class="relative overflow-hidden">
                                ...
                                {if $product->images->isNotEmpty()}
                                    {asset path=$product->images[0]->image_path}
                                {else}https://images.unsplash.com/photo-1578662996442-48f60103fc96?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80
                                {/if}"
                                    alt="{$product->name}"
            ...
            <section class="mx-auto">
                <div class="grid grid-cols-1 md:grid-cols-3">
                    ...
                    <div class="category-card relative h-150 overflow-hidden cursor-pointer group">
                        <img src="
                            {asset path='/images/serum.jpg'}" alt="Serum collection"
                    ...
                    <div class="category-card relative h-150 overflow-hidden cursor-pointer group">
                        <img src="
                            {asset path='/images/moisturizer.jpg'}" alt="Moisturizer collection"
                            class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700">
                        <div class="category-overlay absolute inset-0 group-hover:bg-black/50 transition-colors duration-300">
                        </div>
                        <div class="absolute inset-0 flex items-center justify-center">
                    ...
                    <div class="category-card relative h-150 overflow-hidden cursor-pointer group">
                        <img src="
                            {asset path='/images/cleansers.jpg'}" alt="Cleanser collection"
                            class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700">
                        <div class="category-overlay absolute inset-0 group-hover:bg-black/50 transition-colors duration-300">
                        </div>
                        <div class="absolute inset-0 flex items-center justify-center">
