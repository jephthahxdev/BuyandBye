...
{block name="content"}
                    ...
                    <div>
                        ...
                        <div class="flex space-x-2">
                            {foreach from=$product.sizes item=size}
                                <button
                                    class="w-10 h-10 border border-gray-300 rounded text-sm font-medium hover:border-gray-900 focus:outline-none focus:border-gray-900 {if $size.selected}bg-gray-900 text-white{else}bg-white text-gray-900{/if}">
                                    {$size.name}
                                </button>
                            {/foreach}
                        </div>
                    ...
                    <div>
                        ...
                        <div class="flex space-x-2">
                            {foreach from=$product.colors item=color}
                                <button
                                    class="w-8 h-8 rounded-full border-2 focus:outline-none {if $color.selected}border-gray-900{else}border-gray-300{/if}"
                    ...
                    <div class="prose max-w-none">
                        ...
                        {if $product.specifications}
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                {foreach from=$product.specifications key=spec_name item=spec_value}
                                    <div>
                                        <dt class="text-sm font-medium text-gray-900">{$spec_name}</dt>
                                        <dd class="text-sm text-gray-700">{$spec_value}</dd>
                                    </div>
                                {/foreach}
                            </div>
                        {/if}
    ...
    {* JavaScript for tab functionality and interactions *}
    <script>
