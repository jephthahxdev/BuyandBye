    ...
    <ul class="py-2">
        <li>
            <a href="{$base_url}/admin/dashboard"
                class="flex items-center px-4 py-3 {if $active_page == 'overview' || $active_page == 'dashboard'}bg-gray-50 text-black font-medium{else}text-gray-700 hover:bg-gray-50{/if}">
        ...
        <li>
            <a href="{$base_url}/admin/orders" class="flex items-center px-4 py-3 {if $active_page == 'orders'}bg-gray-50 text-black font-medium{else}text-gray-700 hover:bg-gray-50{/if}">
                <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20">
