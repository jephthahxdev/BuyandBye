                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        {foreach $users as $userData}
                                            <tr class="hover:bg-gray-50">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <span class="text-sm text-gray-600">{$userData.email}</span>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <nav class="inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                                        ...
                                        {section name=page start=1 loop=$pagination.last_page+1}
                                            ...
                                            {if $pageNum == $pagination.current_page}
                                                <span
                                                    class="relative inline-flex items-center px-4 py-2 border border-gray-300 bg-black text-white text-sm font-medium">{$pageNum}</span>
                                            {else}
                                                <a href="?page={$pageNum}"
