                    ...
                    <div class="grid grid-cols-4 gap-6 mb-8 bg-white rounded-lg border border-gray-200 p-4">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-black">{$stats.new_orders}</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-black">{$stats.users_count}</p>
                            </div>
                        </div>
                    </div>
                                        ...
                                        {foreach $active_orders as $order}
                                            <tr class="hover:bg-gray-50">
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <a href="{$base_url}/admin/orders/{$order.id}" class="text-sm font-medium text-gray-600 hover:text-blue-800">
