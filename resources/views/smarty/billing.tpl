                            ...
                            <div class="pr-4">
                                ...
                                {if $billing_addresses|@count == 0}
                                    <div class="flex items-center justify-between bg-gray-50 rounded-lg px-4 py-3 mb-4">
                                        ...
                                        <a href="{$base_url}/account/billing/add" class="bg-gray-600 text-white px-4 py-2 rounded-lg font-medium hover:bg-gray-700 transition">Add Billing Address</a>
                                    </div>
                                {else}
                                    {foreach $billing_addresses as $address}
                                        <div class="border rounded-lg p-4 mb-4 {if $address.is_default}border-gray-600 bg-gray-50{else}border-gray-200 bg-white{/if} flex items-start justify-between">
                                            <div>
                                    ...
                                    {/foreach}
                                    <a href="{$base_url}/account/billing/add" class="text-gray-700 font-medium mt-2 inline-block hover:underline">+ Add Billing Address</a>
                                {/if}
                            </div>
                            ...
                            <div>
                                ...
                                {if $payment_methods|@count == 0}
                                    <div class="flex items-center justify-between bg-gray-50 rounded-lg px-4 py-3 mb-4">
                                        ...
                                        <a href="{$base_url}/account/payment/add" class="bg-gray-600 text-white px-4 py-2 rounded-lg font-medium shadow hover:bg-gray-700 transition">Add Payment Method</a>
                                    </div>
                                {else}
                                    {foreach $payment_methods as $method}
                                        <div class="border rounded-lg px-4 py-6 mb-4 {if $method.is_default}border-gray-600 bg-gray-50{else}border-gray-200 bg-white{/if} flex items-center justify-between">
                                            <div class="flex items-center">
                                                ...
                                                {/if}
                                                <span class="font-mono text-base tracking-widest">**** **** **** {$method.last4}</span>
                                                <span class="ml-2 text-xs text-gray-700 font-medium uppercase">{$method.brand}</span>
                                            </div>
                                            <button class="ml-4 text-gray-400 hover:text-red-600" title="Delete">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
