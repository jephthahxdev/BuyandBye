                            ...
                            <div class="lg:pr-4">
                                ...
                                {else}
                                    {foreach $billing_addresses as $address}
                                        <div
                                            class="border rounded-lg p-3 md:p-4 mb-3 md:mb-4 {if $address.is_default}border-gray-600 bg-gray-50{else}border-gray-200 bg-white{/if} flex items-start justify-between">
                                            <div class="flex-1 min-w-0">
                            ...
                            <!-- Default Payment Method -->
                                ...
                                {else}
                                    {foreach $payment_methods as $method}
                                        <div
                                            class="border rounded-lg px-3 md:px-4 py-4 md:py-6 mb-3 md:mb-4 {if $method.is_default}border-gray-600 bg-gray-50{else}border-gray-200 bg-white{/if} flex items-center justify-between">
                                            <div class="flex items-center min-w-0 flex-1">
                                                ...
                                                <span class="font-mono text-sm md:text-base tracking-widest truncate">**** **** ****
                                                    {$method.last4}</span>
                                                <span
                                                    class="ml-2 text-xs text-gray-700 font-medium uppercase flex-shrink-0">{$method.brand}</span>
                                </div>
                                            <button class="ml-2 md:ml-4 text-gray-400 hover:text-red-600 flex-shrink-0" title="Delete">
                                                <svg class="w-4 h-4 md:w-5 md:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
